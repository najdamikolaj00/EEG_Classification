...
class TCNBlock(nn.Module):
    def __init__(self, input_layer, input_dimension, depth, kernel_size, filters, dropout):
        super(TCNBlock, self).__init__()
        # Block 1
        self.conv1 = nn.Conv1d(input_layer, out_channels=filters, kernel_size=kernel_size, 
        ...
        # Block 2
        self.conv2 = nn.Conv1d(filters, out_channels=filters, kernel_size=kernel_size, 
                         padding=kernel_size // 2, dilation=1, bias=True)
