...
class BCIDatasetBinary(Dataset):
    def __init__(self, data_paths, target_classes=[1, 2], is_standard=True):
        """
        Custom dataset class for EEG (Electroencephalography) data with binary classification.

        Parameters:
            data_paths (list): List of paths to the EEG data files.
            target_classes (list): List of target classes to keep for binary classification.
